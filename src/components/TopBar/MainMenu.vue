...
<template>
  <v-menu transition="scroll-y-transition">
    ...
    <v-list class="mt-2 text-center" item-type="link">
      <v-list-item ref="element">
        <v-list-item-title class="g-menu-item" @click="toggle">{{ $t('menu.toggleFullScreen')
        }}</v-list-item-title>
        <!-- <v-list-item-title class="g-menu-item" @click="ToggleFullScreen">{{ $t('menu.toggleFullScreen')
        }}</v-list-item-title> -->
      </v-list-item>
